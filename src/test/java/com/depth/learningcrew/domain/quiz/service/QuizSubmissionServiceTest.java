...
class QuizSubmissionServiceTest {
        ...
        QuizRecordRepository quizRecordRepository = mock(QuizRecordRepository.class);
        ...
        void submit_success_all_correct() throws Exception {
                ...
                QuizRecordDto.QuizSubmitRequest req = QuizRecordDto.QuizSubmitRequest.builder()
                                .answers(List.of(
                                                QuizRecordDto.QuizSubmitRequest.Answer.builder().quizId(100L)
                                                                .selectedOptions(List.of(2)).build(),
                                                QuizRecordDto.QuizSubmitRequest.Answer.builder().quizId(200L)
                                                                .selectedOptions(List.of(1, 3)).build()))
                                .build();
        ...
        void submit_success_partial_correct() throws Exception {
                ...
                QuizRecordDto.QuizSubmitRequest req = QuizRecordDto.QuizSubmitRequest.builder()
                                .answers(List.of(
                                                QuizRecordDto.QuizSubmitRequest.Answer.builder().quizId(101L)
                                                                .selectedOptions(List.of(2)).build(),
                                                QuizRecordDto.QuizSubmitRequest.Answer.builder().quizId(201L)
                                                                .selectedOptions(List.of(1)).build()))
                                .build();
        ...
        void submit_success_order_invariant_and_duplicates() throws Exception {
                ...
                QuizRecordDto.QuizSubmitRequest req = QuizRecordDto.QuizSubmitRequest.builder()
                                .answers(List.of(
                                                QuizRecordDto.QuizSubmitRequest.Answer.builder().quizId(300L)
                                                                .selectedOptions(Arrays.asList(3, 1, 1, 3)).build()))
                                .build();
        ...
        void submit_success_sparse_option_numbers() throws Exception {
                ...
                QuizRecordDto.QuizSubmitRequest req = QuizRecordDto.QuizSubmitRequest.builder()
                                .answers(List.of(
                                                QuizRecordDto.QuizSubmitRequest.Answer.builder().quizId(500L)
                                                                .selectedOptions(List.of(5, 1)).build()))
                                .build();
        ...
        void submit_conflict_when_already_submitted() {
                ...
                System.out.println("[409 케이스] 테스트 성공 여부 = "
                                + (ex.getErrorCode() == ErrorCode.QUIZ_ALREADY_SUBMITTED_IN_STEP));
